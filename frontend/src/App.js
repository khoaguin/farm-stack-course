...
//       <h1 className="card text-white bg-success mb-1" styleName="max-width: 20rem;">Task Manager</h1>
...
//       </span>
//       <h5 className="card text-white bg-dark mb-3" style={{"marginTop": "15px"}}>Your Tasks</h5>
//       <div>
